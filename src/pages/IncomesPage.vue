...
const exportToExcel = () => {
    const content = buildExportDocument({ title: 'Relatorio de Receitas' });
    const filename = `receitas-${filters.year}-${String(filters.month).padStart(2, '0')}.xls`;
...
const exportToPdf = () => {
    ...
    exportWindow.document.write(buildExportDocument({ title: 'Relatorio de Receitas PDF' }));
                    ...
                    <div v-if="isExportMenuOpen" class="export-menu-panel" role="menu" aria-label="Opcoes de exportacao">
                        ...
                        <button class="export-menu-item" type="button" role="menuitem" @click="exportToExcel">
                            ...
                            <span>
                                ...
                                <small>Tabela organizada com resumo e colunas formatadas.</small>
                            </span>
                        </button>
                    </div>
                </div>
